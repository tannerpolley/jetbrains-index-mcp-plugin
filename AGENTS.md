...
- `ide_attach_repo_to_workspace` - Attach an existing Git repo directory to the current workspace without opening another IDE window.
- `ide_get_repo_scoped_client_config` - Export deterministic broad-plus-repo-scoped Codex client configuration after workspace repo attach or refresh.
...
4. Update this documentation (`AGENTS.md`) for any structural or architectural changes
