 ...
 *
 * These tools support multiple languages (Java, Kotlin, Python, JavaScript/TypeScript, PHP, Rust, C/C++, Markdown)
...
class ToolRegistry {
     ...
     * (Java, Kotlin, Python, JavaScript/TypeScript, PHP, Rust, C/C++, Markdown).
     *
