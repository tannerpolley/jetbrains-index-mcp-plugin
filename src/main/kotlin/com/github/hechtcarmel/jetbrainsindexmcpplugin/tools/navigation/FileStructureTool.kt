 ...
 * showing classes, methods, fields, C/C++ declarations, Markdown headings, and their nesting relationships.
 *
 * Supports: Java, Kotlin, Python, JavaScript, TypeScript, PHP, C/C++, Markdown
 */
class FileStructureTool : AbstractMcpTool() {
    ...
    override val description = """
        ...
        Shows classes, methods, fields, functions, PHP namespaces, C/C++ declarations, constants, enum cases, Markdown headings, and their nesting relationships in a tree format.
